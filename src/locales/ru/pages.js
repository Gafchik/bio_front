...
import purchases from "@/locales/ru/pages/purchases/purchases.json"
import user_map from "@/locales/ru/pages/user-map/user_map.json"
...
import buy_yong_tree from "@/locales/ru/pages/buy-yong-tree/buy-yong-tree.json"
import top_up_wallet from "@/locales/ru/pages/top-up-wallet/top-up-wallet.json"
import store from "@/locales/ru/pages/store/store.json"
import insurance from "@/locales/ru/pages/insurance/insurance.json"
import gift from "@/locales/ru/pages/gift/gift.json"
export default {
    faq: faq,
    contacts: contacts,
    news: news,
